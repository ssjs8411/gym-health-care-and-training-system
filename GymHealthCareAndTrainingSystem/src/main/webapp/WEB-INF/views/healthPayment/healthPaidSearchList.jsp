...
<html>
	<head>
		<meta charset="UTF-8">
		<title>healthPaidSearchList</title>
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> 헬스 프로그램 결제 현황 검색<!-- 제목(ex : 헬스장 리스트) -->
					</div>
						<div class="card-body">
							<div class="table-responsive">
								<form role="form" action="${pageContext.request.contextPath}/healthPaidSearchList" method="post">
