			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> 헬스 프로그램 결제완료화면<!-- 제목(ex : 헬스장 리스트) -->
					</div>
						<div class="card-body">
							<div class="table-responsive">
								...
								<div class="form-group">
									<label for="healthProgramTitle">헬스 프로그램 이름</label>
								...
								<div class="form-group">
									<label for="healthProgramStartDate">헬스 프로그램 시작일</label>
									<div class="form-control">2018년 10월 01일</div>
								</div>
								<div class="form-group">
									<label for="healthProgramEndDate">헬스 프로그램 종료일</label>
